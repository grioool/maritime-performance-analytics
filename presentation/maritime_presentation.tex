...
\AtBeginEnvironment{itemize}{\setlength{\itemsep}{1pt}\setlength{\parskip}{0pt}\setlength{\parsep}{0pt}}
\AtBeginEnvironment{enumerate}{\setlength{\itemsep}{1pt}\setlength{\parskip}{0pt}\setlength{\parsep}{0pt}}

% ---------- Section divider helper ----------
\newcommand{\sectiondivider}[4]{%
  % #1 part number  #2 part title  #3 presenter name  #4 slides covered
  {%
  \setbeamercolor{background canvas}{bg=DarkPink}
  \setbeamercolor{normal text}{fg=white}
  \begin{frame}[plain]
  \color{white}
  \vfill
  {\Large\bfseries\color{SoftPink}#1\par}
  \vspace{0.45cm}
  {\LARGE\bfseries #2\par}
  \vfill
  {\small\color{white!75}#4\par}
  \vspace{0.45cm}
  \end{frame}
  }%
}
...
%------------------------
\begin{frame}[t]{Project context: why Flettner rotors?}
...
\centering
\includegraphics[width=0.90\columnwidth, height=0.65\textheight, keepaspectratio]{Rotor_characteristics.png}
\end{column}
\end{columns}
\end{frame}

%------------------------
\begin{frame}[t]{Vessel and rotor specification}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.46\textwidth}
\centering
\includegraphics[width=\columnwidth, height=0.75\textheight, keepaspectratio]{Vessel_specification.png}
\end{column}
...
%------------------------
\begin{frame}[t]{Data sources and trajectories}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.52\textwidth}
\centering
\begin{minipage}[t][0.72\textheight][t]{\columnwidth}
\centering
\vfill
\includegraphics[width=\columnwidth, height=0.7\textheight, keepaspectratio]{all_trajectories_osm.png}
\vfill
...
%------------------------
\begin{frame}[t]{Feature engineering: leakage-aware design}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.50\textwidth}
\footnotesize
...
%------------------------
\begin{frame}[t]{Model hierarchy and rotor scenario methodology}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.50\textwidth}
\footnotesize
...
%------------------------
\begin{frame}[t]{Model results: held-out test performance}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.48\textwidth}
...
\centering
\includegraphics[width=\columnwidth, height=0.68\textheight, keepaspectratio]{predicted_vs_actual.png}
...
%------------------------
\begin{frame}[t]{Feature importance and prediction intervals}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.56\textwidth}
\centering
\includegraphics[width=\columnwidth, height=0.72\textheight, keepaspectratio]{feature_importance.png}
...
%------------------------
\begin{frame}[t]{Rotor scenario: speed uplift and weather-window impact}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.54\textwidth}
\centering
\includegraphics[width=\columnwidth, height=0.64\textheight, keepaspectratio]{rotor_scenario.png}
...
%------------------------
\begin{frame}[t]{Rotor gain surface: where does it help?}
\centering
\includegraphics[width=0.90\textwidth, height=0.50\textheight, keepaspectratio]{rotor_gain_surface.png}

{\scriptsize Gain concentrated at beam/quartering angles (50-130$^\circ$) above 8 m/s. Headwind/tailwind sectors poor. Sea state acts as a gate, not a gain driver.}
...
%------------------------
\begin{frame}[t]{Extension 1: Energy, fuel, and CO$_2$ impact}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.55\textwidth}
\centering
\includegraphics[width=\columnwidth, height=0.75\textheight, keepaspectratio]{energy_fuel_co2.png}
...
%------------------------
\begin{frame}[t]{Extension 2: Route segmentation by heading regime}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.54\textwidth}
\centering
\includegraphics[width=\columnwidth, height=0.62\textheight, keepaspectratio]{route_segmentation.png}
...
%------------------------
\begin{frame}[t]{Extension 3: Route optimisation - Dijkstra proof of concept}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.54\textwidth}
\centering
\includegraphics[width=\columnwidth, height=0.75\textheight, keepaspectratio]{route_optimization.png}
...
%------------------------
\begin{frame}[t]{Extension 4: High-gain moment detection}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.56\textwidth}
\centering
\includegraphics[width=\columnwidth, height=0.72\textheight, keepaspectratio]{rotor_gain_detection.png}
...
%------------------------
\begin{frame}[t]{Extension 5: Monte Carlo routing under uncertainty}
\begin{columns}[T,onlytextwidth]
\begin{column}{0.52\textwidth}
\centering
\includegraphics[width=0.88\columnwidth, height=0.9\textheight, keepaspectratio]{monte_carlo_routing.png}
...
\begin{block}{Key takeaway}
Uncertainty-aware routing beats greedy shortest path under the rotor-gain objective.
\end{block}
\end{column}
\end{columns}
\end{frame}
...
\centering
\includegraphics[width=0.95\textwidth, height=0.72\textheight, keepaspectratio]{prediction_intervals_95percent.png}
...
\begin{column}{0.48\textwidth}
\centering
\includegraphics[width=\columnwidth, height=0.72\textheight, keepaspectratio]{rotor_polar.png}
{\small Rotor polar gain diagram.}
\end{column}
\begin{column}{0.48\textwidth}
\centering
\includegraphics[width=\columnwidth, height=0.72\textheight, keepaspectratio]{rotor_seasonal.png}
...
\begin{column}{0.48\textwidth}
\centering
\includegraphics[width=\columnwidth, height=0.72\textheight, keepaspectratio]{rotor_opportunity_voyage501.png}
{\small Voyage 501: rotor opportunity map along the track.}
\end{column}
\begin{column}{0.48\textwidth}
\centering
\includegraphics[width=\columnwidth, height=0.72\textheight, keepaspectratio]{voyage_fuel_savings.png}
...
\begin{column}{0.49\textwidth}
\centering
\includegraphics[width=\columnwidth, height=0.64\textheight, keepaspectratio]{rotor_decision_map.png}
{\small Rule-based high-gain zones.}
\end{column}
\begin{column}{0.49\textwidth}
\centering
\includegraphics[width=\columnwidth, height=0.64\textheight, keepaspectratio]{rotor_classifier.png}
...
\centering
\includegraphics[width=0.95\textwidth, height=0.72\textheight, keepaspectratio]{rotor_hs_interaction.png}
...
\begin{column}{0.49\textwidth}
\centering
\includegraphics[width=\columnwidth, height=0.64\textheight, keepaspectratio]{model_comparison.png}
{\small All four model MAE/RMSE/$R^2$ side-by-side.}
\end{column}
\begin{column}{0.49\textwidth}
\centering
\includegraphics[width=\columnwidth, height=0.64\textheight, keepaspectratio]{rotor_zone_analysis.png}
